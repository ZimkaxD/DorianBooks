  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-1 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link " aria-current="page" href="index2.php">Контакты</a>
        </li>
...
<div class="container text-center my-5">
  <head>
<a>
<h3>СПРАВОЧНАЯ СЛУЖБА
  </h3>
  </p>
<h6 >Справочная служба:</p>
<h6>
8 (017) 399-73-80
</p>
<h6>
...
<h6>
office@dorianbooks.ru
</p>
<h6>
Торговый отдел:
</p>
<h6>
torgotdel@dorianbooks.ru
</p>
<h6>
Интернет-магазин:
</p>
<h6>
drbooks5@dorianbooks.ru
</p>
</div>
        </html>
    </body>
