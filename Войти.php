...
<h6>
    <p>При входе, вы соглашаетесь с нашими условиями<a href="#">Политика & Конфидициальность</a>.</p>

    <button class="btn btn-secondary"type="submit" class="registerbtn">Войти</button>
  </div>
  
  <div class="container signin">
    <p>У вас нет учетной записи? <a href="Вход.php">Зарегистрироваться</a>.</p>
  </div>
</form>
        </html>
    </body>
