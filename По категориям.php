  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-1 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link " aria-current="page" href="Корзина.html">Корзина</a>
        </li>
          <a class="nav-link " href="Помощь.html">Помощь</a>
        </li>
        <li class="nav-item">
        ...
        <!--<li class="nav-item dropdown">-->
         <!-- <a class="nav-link dropdown-toggle" href="По категориям.html" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <li class="nav-item">
          <a class="nav-link " aria-current="page" href="Вход.html">Вход</a>
        </li>
        <li class="nav-item">
